...
class GeneratedResearchStrategy(StrategyBase):
    def __init__(self, config):
        ...
        self._spec = json.loads("{\"context_tf\": null, \"description\": \"(guided template: builder_v2)\", \"entry_tf\": \"1h\", \"long\": {\"conditions_all\": [{\"expr\": \"pin_bar(open, high, low, close, \\\"bull\\\", 2.0, 1.0, 0.2)@1h\", \"tf\": \"1h\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 1.5, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}, \"market\": {\"exchange\": \"binance\", \"market_type\": \"futures\", \"symbol\": \"BTCUSDT\"}, \"name\": \"EMA-CROSS_OVER\", \"required_timeframes\": [\"1h\"], \"short\": {\"conditions_all\": [{\"expr\": \"pin_bar(open, high, low, close, \\\"bear\\\", 2.0, 1.0, 0.2)@1h\", \"tf\": \"1h\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 1.5, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}}")
