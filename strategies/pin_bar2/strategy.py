...
class GeneratedResearchStrategy(StrategyBase):
    def __init__(self, config):
        ...
        self._spec = json.loads("{\"context_tf\": \"15m\", \"description\": \"(guided template: builder_v2)\", \"entry_tf\": \"15m\", \"long\": {\"conditions_all\": [{\"expr\": \"(atr(14))@15m > 1.5 * shift((atr(14))@15m, 1)\", \"tf\": \"15m\"}, {\"expr\": \"rsi(close, 20)@15m < 30.0\", \"tf\": \"15m\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 3.0, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}, \"market\": {\"exchange\": \"oanda\", \"market_type\": \"spot\", \"symbol\": \"EURUSD\"}, \"name\": \"pin_bar2\", \"required_timeframes\": [\"15m\"], \"short\": {\"conditions_all\": [{\"expr\": \"(atr(14))@15m > 1.5 * shift((atr(14))@15m, 1)\", \"tf\": \"15m\"}, {\"expr\": \"rsi(close, 20)@15m > 70.0\", \"tf\": \"15m\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 3.0, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}}")
