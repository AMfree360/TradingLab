...
class GeneratedResearchStrategy(StrategyBase):
    def __init__(self, config):
        ...
        self._spec = json.loads("{\"context_tf\": null, \"description\": \"(guided template: builder_v2)\", \"entry_tf\": \"15m\", \"long\": {\"conditions_all\": [{\"expr\": \"close > ema(close, 200)\", \"tf\": \"15m\"}, {\"expr\": \"pin_bar(open, high, low, close, \\\"bull\\\", 2.0, 1.0, 0.2)@15m\", \"tf\": \"15m\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 3.0, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}, \"market\": {\"exchange\": \"binance\", \"market_type\": \"spot\", \"symbol\": \"BTCUSDT\"}, \"name\": \"pin_bar_v2\", \"required_timeframes\": [\"15m\"], \"short\": {\"conditions_all\": [{\"expr\": \"close < ema(close, 200)\", \"tf\": \"15m\"}, {\"expr\": \"pin_bar(open, high, low, close, \\\"bear\\\", 2.0, 1.0, 0.2)@15m\", \"tf\": \"15m\"}], \"enabled\": true, \"exit_conditions_all\": [], \"stop\": {\"atr_length\": 14, \"atr_multiplier\": 3.0, \"buffer\": null, \"candle_bars_back\": null, \"ma_length\": null, \"ma_type\": null, \"percent\": null, \"structure_lookback_bars\": null, \"type\": \"atr\"}}}")
